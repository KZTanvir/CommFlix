...
<html lang="en">
<?php
$siteTitle = "Search | CommFlix @KZTanvir"; 
...
<body>
    ...
    <section>
        <div class="card panel-card">
            <div class="panel-heading" style="border-radius: unset; background-color: #F44336; margin-bottom: 8px;">Search Results</div>            
            ...
            <div class="movie-container">
                ...
                <?php
                    ...
                    echo "<p>Search result will appear here.</p>";
                }
                ?>
            </div>
        </div>
